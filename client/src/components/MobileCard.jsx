...
const MobileCard = ({ id, image, title, price, os, processor, memory, brand }) => {
  ...
  return (
    <div className='bg-gray-100 shadow-xl p-4 rounded-xl'>
      ...
      <button className='bg-blue-500 shadow-xl rounded-lg p-2 w-full mt-2 text-blue-200 hover:text-blue-500 hover:bg-blue-200 transition 3s' onClick={handleOpenModal}>Learn More</button>
